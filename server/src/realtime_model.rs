...
pub enum RealtimeMessage {
    ...
    DeleteDisruption(String), // disruption id
...
pub struct StopTime {
    stop_time_identifier: StopTimeIdentifier,
    arrival_time: NaiveDateTime,
    departure_time: NaiveDateTime,
}

pub enum VehicleIdentifier {
    Base(BaseVehicleIdentifier),
    Realtime(String), //
}

pub struct BaseVehicleIdentifier {
